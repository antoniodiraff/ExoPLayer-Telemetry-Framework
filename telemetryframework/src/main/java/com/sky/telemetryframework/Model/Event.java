...
import com.sky.telemetryframework.DeviceInfo;
...
public class Event {
    ...
    public Event(DeviceInfo device_info, ArrayList<EventElement> events_list) {

        if (events_list != null) {
            this.events_list = events_list;
        } else {
            this.events_list = new ArrayList<EventElement>(2);
        }
